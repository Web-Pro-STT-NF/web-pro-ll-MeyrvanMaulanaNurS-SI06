...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <!-- Mahasiswa-->
        <section class ="testimonial section-pandding" id="mahasiswa">
            <div class="container">
            <div class="text-center">
                    <h2 class="section-heading text-uppercase">Daftar Mahasiswa</h2>
                <table class="table">
    <thead>
    <tr>
      <th scope="col">No.</th>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-3 col-sm-6 my-3">
                        <a href="#!"><img class="img-fluid img-brand d-block mx-auto" src="<?php echo base_url("assets/img/logos/microsoft.svg")?>" alt="..." aria-label="Microsoft Logo" /></a>
                    </div>
                    <div class="col-md-3 col-sm-6 my-3">
                        <a href="#!"><img class="img-fluid img-brand d-block mx-auto" src="<?php echo base_url("assets/img/logos/google.svg")?>" alt="..." aria-label="Google Logo" /></a>
                    </div>
                    <div class="col-md-3 col-sm-6 my-3">
                        <a href="#!"><img class="img-fluid img-brand d-block mx-auto" src="<?php echo base_url("assets/img/logos/facebook.svg")?>" alt="..." aria-label="Facebook Logo" /></a>
                    </div>
                    <div class="col-md-3 col-sm-6 my-3">
                        <a href="#!"><img class="img-fluid img-brand d-block mx-auto" src="<?php echo base_url("assets/img/logos/ibm.svg")?>" alt="..." aria-label="IBM Logo" /></a>
                    </div>
                </div>
            </div>
        </div>
