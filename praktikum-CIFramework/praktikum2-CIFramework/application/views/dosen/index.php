...
<body>
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">View Form Dosen</h3>
  ...
  <div class="form-group row">
    <label for="nim" class="col-4 col-form-label">ID</label> 
    <div class="col-8">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="nidn" name="nidn" type="text" class="form-control" value="">
      </div>
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    <label for="tgl_lahir" class="col-4 col-form-label">Pendidikan</label> 
    <div class="col-8">
      <div class="input-group">
        <div class="input-group-prepend">
          <div class="input-group-text">
        ...
        <input id="pendidikan" name="pendidikan" type="text" class="form-control" value="">
      </div>
    </div>
  </div>
  <div class="form-group row">
